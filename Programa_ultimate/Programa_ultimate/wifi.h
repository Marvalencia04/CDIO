...
/////////////// HTTP GET  ////////////////
//////////////////////////////////////////////////////
void wifi::HTTPGet(String fieldData[], int numFields) {
  ...
  void wifi::enviardatos(int NHumedad, int NSal, float NTemperatura, float NPh, int NLuz) {
    String data[numFields + 1];  // Podemos enviar hasta 8 datos
